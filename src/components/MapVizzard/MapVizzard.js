    ...
    return (
        <div className="row">
          <div id="map_layers" className="col-md-3">
            <MapLayers val={val} layers={layers} setLayers={setOpeningLayers} setVal={setVal} activeLayer={activeLayer} setActiveLayer={setActiveLayer}/>
          </div>
          <div id="map_options" className="col-md-3">
            <MapOptions val={val} layers={layers} setLayers={setOpeningLayers} setVal={setVal} activeLayer={activeLayer}/>
          </div>
